...
//     console.log("Igreso una letra. ingrese la nota en numeros porfavor");
// }
...
let notaTrimestre1 = parseInt(prompt("Ingresa la primer nota"));
let notaTrimestre2 = parseInt(prompt("Ingresa la segunda nota"));
let notaTrimestre3 = parseInt(prompt("Ingresa la tercer nota"));
